...
```bash
# Train all 4 models with identical conditions
...
Trains 4 models with **identical conditions:**
...
4. **ASTGCN** - Attention-based spatial-temporal
...
| ASTGCN       | ~4.29      | ~0.02\*   | ~25 min       |

\*ASTGCN may fail on 29-day dataset (designed for longer sequences)
