...
\begin{itemize}
    ...
    \item \textbf{R² 0.82:} The model explains 82\% of the variance in traffic speeds, demonstrating strong predictive power. The remaining 18\% likely represents stochastic fluctuations, accidents, or other unmodeled events.
...
\begin{itemize}
    ...
    \item Test generalization: R² improved from 0.78 to 0.82
...
\begin{tabular}{lcccc}
\toprule
\textbf{Configuration} & \textbf{MAE} & \textbf{RMSE} & \textbf{R²} & \textbf{$\Delta$ MAE} \\
\midrule
...
\begin{tabular}{ccccc}
\toprule
\textbf{Samples} & \textbf{\% Full} & \textbf{MAE} & \textbf{R²} & \textbf{Comment} \\
\midrule
...
\begin{tabular}{ccc}
\toprule
\textbf{Weight Decay} & \textbf{Test MAE} & \textbf{Test R²} \\
\midrule
0.0 & 3.35 & 0.79 \\
