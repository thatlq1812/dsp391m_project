...
\begin{enumerate}
    ...
    \item \textbf{Comparative Analysis:} Benchmark against established baseline models (LSTM, GCN, GraphWaveNet, ASTGCN) to validate architectural improvements
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Systematic benchmarking} against 4 baseline models (LSTM, GCN, GraphWaveNet, ASTGCN)
