...
def generate_mock_traffic(run_dir: Path) -> None:
    ...
    NOTE: vehicle_count is MOCK data generated randomly.
    Google Directions API does NOT provide vehicle counts.
    This field should NOT be used for ML training.
    """
        ...
        traffic_data.append(
            {
                ...
                # NOTE: vehicle_count is MOCK/SYNTHETIC - no real data source
